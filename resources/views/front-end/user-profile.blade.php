<x-guest-layout>
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-order-tab" style="font-size: 14px; text-align: center;"
                                    href="{{ route('user_order') }}"><i data-feather="shopping-bag"></i>{{ __('messages.orders') }}</a>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-address-tab" type="button" role="tab"
                                    style="font-size: 14px; text-align: center;"
                                    href="{{ route('user_addresses') }}"><i data-feather="map-pin"></i>{{ __('messages.addresses') }}</a>
                            </li>
                            <li class="nav-item" role="presentation">
                ...
                <form method="post" action="{{ route('edit_profile') }}" class="row g-4" id="edit-profile-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="post_code" name="post_code"
                                placeholder="{{ __('messages.post_code') }}" value="{{ $buyerAddress->post_code }}">
                            ...
                            <select class="form-control" id="prefectures" name="prefectures">
                                @foreach ($prefecture as $item1)
                                    <option value="{{ $item1->id }}"
                                        {{ $item1->id == $buyerAddress->prefecture_id ? 'selected' : '' }}>
                                        {{ $item1->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="city" name="city"
                                placeholder="{{ __('messages.city_placeholder') }}" value="{{ $buyerAddress->city }}">
                            <label for="city">{{ __('messages.city') }}</label>
                            <span class="error" style="color:red" id="error-city"></span>
                        </div>

                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="chome" name="chome"
                                placeholder="{{ __('messages.chome_placeholder') }}" value="{{ $buyerAddress->chome }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="building" name="building"
                                placeholder="{{ __('messages.building_placeholder') }}"
                                value="{{ $buyerAddress->building }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="roomno" name="roomno"
                                placeholder="{{ __('messages.roomno_placeholder') }}" value="{{ $buyerAddress->room_no }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input class="form-control" id="phone" name="phone"
                                placeholder="{{ __('messages.phone_placeholder') }}" value="{{ $user->phone }}">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn theme-bg-color btn-md text-white"
                            onclick="validateProfileForm()">{{ __('messages.btn_save') }}</button>
    ...
    <div class="modal fade theme-modal remove-profile" id="confirmEditProfile" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
            <div class="modal-content" style="background-color: #f5f5f5;">
                <!-- Light gray with a little smaller width -->
                ...
                <div class="modal-footer">
                    <button type="button" class="btn theme-bg-color btn-md fw-bold text-light"
                        id="confirmYes">{{ __('messages.btn_yes') }}</button>
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('edit_password') }}" class="row g-4" id="editPasswordForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-secondary btn-md" data-bs-dismiss="modal"
                            style="background-color: #ff6b6b;margin-right: 5px; margin-left: 5px;">{{ __('messages.btn_close') }}</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade theme-modal remove-profile" id="confirmToEditPassword" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
            <div class="modal-content" style="background-color: #f5f5f5;">
                <div class="modal-header d-block text-center">
                    <h5 class="modal-title w-100" id="exampleModalLabel22">{{ __('messages.are_you_sure_to_edit') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="remove-box">
                        <p>{{ __('messages.your_password_will_be_changed') }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn theme-bg-color btn-md fw-bold text-light"
                        id="confirmYesForPassword">{{ __('messages.btn_yes') }}</button>
                    <button type="button" class="btn btn-animation btn-md fw-bold" data-bs-dismiss="modal"
                        style="background-color: #ff6b6b;border-color: #ff6b6b;">{{ __('messages.btn_no') }}</button>
                </div>
            </div>
...
<script>
    function validateProfileForm() {
        ...
        if (!building) {
            ...
            isValid = false;
            document.getElementById('error-building').textContent =
                '{{ __('messages.valid_building_error_message')}}';
        }
    ...
    function validatePasswordChangeForm() {
        ...
        if (!newPassword) {
            ...
            document.getElementById('error-newpassword').textContent =
                '{{ __('messages.valid_new_password_error_message') }}';
        }
