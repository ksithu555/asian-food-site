                ...
                <form method="post" action="{{ route('edit_profile') }}" class="row g-4" id="edit-profile-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="post_code" name="post_code"
                                placeholder="Post Code" value="{{ $buyerAddress->post_code }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="city" name="city"
                                placeholder="City, Ward, Town" value="{{ $buyerAddress->city }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="chome" name="chome"
                                placeholder="Chome, Banchi, Go" value="{{ $buyerAddress->chome }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="building" name="building"
                                placeholder="Building, Apartment, Company Name"
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <input type="text" class="form-control" id="roomno" name="roomno"
                                placeholder="Unit, Room No" value="{{ $buyerAddress->room_no }}">
                        ...
                        <div class="form-floating mb-4 theme-form-floating form-group">
                            <select class="form-control" id="place" name="place">
                                <option value="Home" {{ $buyerAddress->place == 'Home' ? 'selected' : '' }}>Home
                                </option>
                                <option value="Office" {{ $buyerAddress->place == 'Office' ? 'selected' : '' }}>Office
                                </option>
                                <option value="Other" {{ $buyerAddress->place == 'Other' ? 'selected' : '' }}>Other
                                </option>
                            </select>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn theme-bg-color btn-md text-white"
                            onclick="validateProfileForm()">Save</button>
    ...
    <div class="modal fade theme-modal remove-profile" id="confirmToEditPassword" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
            <div class="modal-content" style="background-color: #f5f5f5;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn theme-bg-color btn-md fw-bold text-light"
                        id="confirmYesForPassword">Yes</button>
                    <button type="button" class="btn btn-animation btn-md fw-bold" data-bs-dismiss="modal"
                        style="background-color: #ff6b6b;border-color: #ff6b6b;">No</button>
                </div>
            </div>
    ...
    function validateProfileForm() {
        ...
        if (!building) {
            ...
            document.getElementById('error-building').textContent =
                'The building information must not exceed 255 characters.';
        }
