                                                                ...
                                                                <table class="table cart-table table-borderless">
                                                                    ...
                                                                    @foreach ($orderDetails as $index => $order)
                                                                        <tbody>
                                                                            <tr class="table-order">
                                                                                ...
                                                                                <td>
                                                                                    <a
                                                                                        href="{{ route('show-product-left-thumbnail', ['id' => $order->product_id]) }}">
                                                                                        <h5 style="width: 100px;">
                                                                                            {{ mb_substr($order->product_name, 0, 20) . '...' }}
                                                                                        </h5>
                                                                                    </a>
                                                                                </td>
                                                                                @php
                                                                                    $shop = DB::table('sellers')
                                                                                        ->where(
                                                                                            'user_id',
                                                                                            $order->seller_id,
                                                                                        )
                                                                                ...
                                                                                <td>
                                                                                    <h5>¥
                                                                                        {{ number_format($order->selling_price * $order->qty, 0, '.', ',') }}
                                                                                    </h5>
                                                                                </td>
                                                                                <td>
                                                                                    <h5>{{ $order->size }}</h5>
                                                                        ...
                                                                        @if ($order->status == 'Cancel' || $order->status == 'Cash Cancel')
                                                                            <div class="modal fade theme-modal remove-profile"
                                                                                id="showCancelReason{{ $order->order_detail_id }}"
                                                                    ...
                                                                    <tfoot>
                                                                        ...
                                                                        <tr class="table-order">
                                                                            ...
                                                                            <td>
                                                                                <h4>¥
                                                                                    {{ number_format($couponDiscountAmount, 0, '.', ',') }}
                                                                                </h4>
                                                                            </td>
                                                                        </tr>
