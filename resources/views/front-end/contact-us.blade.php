                    ...
                    <div class="right-sidebar-box">
                        <form class="contact-form" method="POST" action="{{ route('contact') }}" id="contact-form">
                                    ...
                                    <div class="mb-md-4 mb-3 custom-form">
                                        ...
                                        <div class="custom-input">
                                            <input type="tel" class="form-control" id="phone"
                                                placeholder="{{ __('messages.enter_phone') }}" maxlength="10"
                                ...
                                <div class="col-12">
                                    <div class="mb-md-4 mb-3 custom-form">
                                        ...
                                        <div class="custom-textarea">
                                            <textarea class="form-control" id="message" placeholder="{{ __('messages.enter_message') }}" rows="6" name="message"
                            ...
                            <button class="btn btn-animation theme-bg-color ms-auto fw-bold" type="button"
                                onclick="validateContactForm()">{{ __('messages.btn_send_message') }}</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        function validateContactForm() {
            ...
            if (!phone) {
                ...
                document.getElementById('error-phone').textContent =
                    '{{ __('messages.valid_phone_error_message') }}';
            }
