                            ...
                            <div class="shop-left-sidebar">
                                ...
                                <div class="filter-category">
                                    <div class="filter-title">
                                        ...
                                        <a href="/products">{{ __('messages.clear_all') }}</a>
                                    </div>
                                    <ul>
                                        @if (!empty($searchHistory))
                                            @foreach ($searchHistory as $searchHist)
                                                <li
                                                    style="background-color: {{ $searchHist === $sHistory ? '#ffcccb' : 'transparent' }}">
                                                    <a href="#"
                                                        onclick="updateSearchHist('{{ $searchHist }}')">{{ $searchHist }}</a>
                                                    <span class="remove-search-item" data-search="{{ $searchHist }}"
                                                        onclick="removeSearchItem(this)"
                                    ...
                                    <div class="product-box-3 h-100 wow fadeInUp"
                                        ...
                                        <div class="product-header">
                                            <div class="product-image">
                                                ...
                                                <a
                                                    href="{{ route('show-product-left-thumbnail', ['id' => $product->id]) }}">
                                                    <img width="100"
                                        ...
                                        <div class="product-footer">
                                            <div class="product-detail">
                                                ...
                                                <h6 class="unit">{{ mb_substr($product->product_size, 0, 20) }}</h6>
                                                <h5 class="price">
