                            ...
                            <div class="shop-left-sidebar">
                                ...
                                <div class="filter-category">
                                    <div class="filter-title">
                                        ...
                                        @if (!empty($ids))
                                            <a href="{{ route('show-discount-product', ['ids' => $ids]) }}">{{ __('messages.clear_all') }}</a>
                                        @else
                                            <a href="{{ route('show-discount-product', ['topic' => $topic]) }}">{{ __('messages.clear_all') }}</a>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-item">
                                        <div style="display: flex; align-items: center;">
                                            <input class="form-control form-control-sm mr-sm-2" type="search"
                                                placeholder="{{ __('messages.search') }}" aria-label="{{ __('messages.search') }}" id="search" name="search"
                                                value="{{ $search }}"
