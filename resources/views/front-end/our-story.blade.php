                    ...
                    <div class="business-box">
                        <div>
                            <div class="business-number">
                                @if ($thirdStory->image)
                                    <img src="{{ asset('images/' . $thirdStory->image) }}" class="img-fluid"
                                        alt="">
                                @else
                                    <h2>{{ $numberImage++ }}</h2>
                                @endif
            ...
            <div class="row">
                ...
                <div class="col-xxl-3">
                    <div class="poster-box"
                        style="display: flex; align-items: center; justify-content: center; height: 100%;">
                        <div class="poster-image">
                            <img src="{{ asset('images/' . $stories[3]->image) }}" class="img-fluid" alt=""
                ...
                <div class="row">
                    <div class="col-xxl-4 order-lg-2">
                        <div class="poster-box"
                            style="display: flex; align-items: center; justify-content: center; height: 100%;">
                            <div class="poster-image">
                                <img src="{{ asset('images/' . $stories[0]->image) }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
        ...
        <section class="become-service section-b-space">
            ...
            <div class="row">
                ...
                <div class="col-xxl-3">
                    <div class="service-box">
                        <div class="service-svg">
                            <img src="{{ asset('images/' . $secondStory->image) }}" class="img-fluid"
                                alt="">
                        </div>
