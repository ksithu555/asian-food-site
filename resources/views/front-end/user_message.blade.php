                                    ...
                                    <div class="row" style="margin-bottom: 5px;">
                                        @if ($userNotis->count() > 0)
                                            ...
                                            <div class="col-md-2 text-right"
                                                ...
                                                <button id="clearAllNotifications" class="btn btn-danger"
                                                    style="background-color: #caece1;display: flex; align-items: center; padding: 10px 20px; font-size: 16px; border-radius: 5px;">
                                                ...
                                                <div class="modal fade theme-modal remove-profile" id="removeNotiAll"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('remove_message_all', ['id' => $buyer->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button type="submit"
