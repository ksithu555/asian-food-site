                    ...
                    <div class="log-in-box center">
                        <div class="log-in-title">
                            ...
                            <form method="POST" action="{{ route('adduser') }}" class="row g-4" id="userRegisterForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating theme-form-floating">
                                        <input type="password" name="password_confirmation" class="form-control" placeholder="{{ __('messages.enter_password_confirmation') }}">
                                        <label for="password_confirmation">{{ __('messages.confirmed_password') }}</label>
    ...
    <script>
        function validateUserForm() {
            ...
            if (password && !password_confirmation) {
                isValid = false;
                document.getElementById('error-confirmed-password').textContent = '{{  __('messages.enter_password_confirmation_error_message') }}';
            } else if (password !== password_confirmation) {
                isValid = false;
                document.getElementById('error-confirmed-password').textContent = '{{ __('messages.password_not_match_error_message') }}';
            }
            ...
            if (!room) {
                isValid = false;
                document.getElementById('error-room-no').textContent = '{{ __('messages.enter_roomno_error_message') }}';
            } else if (room.length > 255) {
                isValid = false;
                document.getElementById('error-room-no').textContent = '{{ __('messages.valid_roomno_error_message') }}';
            }

            if (!checkbox.checked) {
                isValid = false;
                document.getElementById('error-flexCheckDefault').textContent = '{{ __('messages.you_must_agree_terms') }}';
            }
