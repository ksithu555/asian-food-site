                                ...
                                <div class="right-box-contain">
                                    ...
                                    <div class="price-rating">
                                        ...
                                        <div class="product-rating custom-rate">
                                            ...
                                            <span class="review"><?php echo $count; ?> {{ __('messages.customer_reviews') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="buy-box">
                                        ...
                                        <a href="{{ route('show-comparelist', ['id' => $id]) }}">
                                            ...
                                            <span>{{ __('messages.add_to_compare') }}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="nav nav-tabs custom-nav" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="description-tab" data-bs-toggle="tab"
                                                ...
                                                role="tab">{{ __('messages.description') }}
                                            </button>
                                        </li>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <div class="review-title-2">
                                                                        <h4 class="fw-bold">
                                                                            {{ __('messages.review_this_product') }}
                                                                        </h4>
                            ...
                            <div class="vendor-box">
                                <div class="vendor-contain">
                                    <div class="vendor-image">
                                        <img src="{{ asset('upload/shop/' . $product->user->seller->shop_logo) }}"
                                        ...
                                        <li>
                                            <div class="address-contact">
                                                ...
                                                <h5>{{ __('messages.address') }}: <span
                                                        class="text-content">〒{{ formatZipCode($product->user->seller->zip_code) }}</span><br>
                                                    <span
                                                        class="text-content">{{ $product->user->seller->city }}</span>
                                                    <span
                                                        class="text-content">{{ $product->user->seller->chome }}</span>
                                                    <span
                                                        class="text-content">{{ $product->user->seller->building }}</span>
                                                    <span
