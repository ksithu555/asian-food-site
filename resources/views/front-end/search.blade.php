                                        ...
                                        <div class="product-box-3 h-100">
                                            ...
                                            <div class="product-footer">
                                                <div class="product-detail">
                                                    <span
                                                        class="span-name">{{ $product->Category->{'category_name_' . app()->getLocale()} ?? $product->Category->category_name }}</span>
                                                    <a
                                                        href="{{ route('show-product-left-thumbnail', ['id' => $product->id]) }}">
                                                    ...
                                                    <h6 class="unit">{{ mb_substr($product->product_size, 0, 20) }}
                                                    </h6>
                                                    <h5 class="price">
