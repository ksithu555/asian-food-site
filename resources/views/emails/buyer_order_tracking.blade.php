    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center;">
                {{ __('messages.order_status_by_shop', ['status' => $orderDetails->first()->status, 'shop_name' => $orderDetails->first()->seller->shop_name]) }}
            </p>
            <p style="text-align: right">{{ \Carbon\Carbon::now()->format('F j, Y') }}</p>
            <h2>{{ __('messages.dear', ['name' => $orderDetails->first()->buyer->name]) }}</h2>
