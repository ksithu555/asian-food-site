...
@section('seller')
    ...
    <div class="page-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" class="theme-form theme-form-2 mega-form"
                                        action="{{ route('update.product') }}" enctype="multipart/form-data" id="tagsForm">
                                        @csrf
        ...
        @foreach ($multiImgs as $key => $img)
            <div class="modal fade theme-modal remove-coupon" id="deleteModal_{{ $img->id }}" aria-hidden="true"
                tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header d-block text-center">
