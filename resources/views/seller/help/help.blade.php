...
@section('seller')
                                        ...
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link {{ $activeTab == 'second' ? 'active' : '' }}"
                                                    ...
                                                    type="button" role="tab"><i class="icon-cloud-up"></i>Sent</button>
                                            </li>
                                        </ul>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ul>
                                                                                ...
                                                                                <li>
                                                                                    <a
                                                                                        href="{{ route('help.detail', $item->id) }}">
    ...
    @foreach ($sent as $key => $item)
        <div class="modal fade theme-modal remove-coupon" id="deleteModalToggle{{ $item->id }}" aria-hidden="true"
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
