                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="log-in-title">
                            <h3 style="text-wrap">{{ __('messages.welcome_to_asian_food_museum') }} </h3>
                            <h5>{{ __('messages.login_to_your_account') }}</h5>
                        </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <div class="forgot-box">
                                            ...
                                            <a href="{{ route('password.request') }}"><i class="fa fa-key"></i> {{ __('messages.forget_password') }}</a>
                                        </div>
                                    </div>
