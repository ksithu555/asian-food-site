                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" id="registercustomer"
                                        ...
                                        <div class="mb-4 row  align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Title Name"
                                                    name="title" id="title"
                                        ...
                                        <div class="mb-4 row  align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="subtitle Name"
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img id="preview-image-before-upload" alt="your image"
                                                    @if (!empty($data->image)) src="{{ asset('images/' . ($data->image ?? 'blog/blog-details.jpg')) }}"
                                                            style="max-width: 100px;"
                                                        @else
                                                            style="display: none; max-width: 100px;" @endif />
