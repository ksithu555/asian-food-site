                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" id="registerblog"
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            <label class="form-label-title col-lg-2 col-md-3 mb-0">Subject</label>
                                        ...
                                        <div class="row align-items-center">
                                            <label class="col-lg-2 col-md-3 col-form-label form-label-title">Content
                                            </label>
                                            <div class="col-md-9 col-lg-10">
